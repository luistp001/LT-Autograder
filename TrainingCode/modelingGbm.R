...
# This script trains and saves two Gradient Boosting Machines to
# predict the scores of the essays.

double_data = TRUE
ide = 5		# interaction.depth
tf = 0.5	# bag fraction
ncvt = 2	# number of folds for cross validation to choose	
		# the number of trees.
...
if (actual == 'model_60'){ #Parameters for one model
sh = 0.001	# shrinkage
ntrees = 5000
}
if (actual == 'model_62'){ #Parameter for second model
sh = 0.01	# shrinkage
ntrees = 500
}
...
models[[SET]] <- list( gbm1, best.iter)
}
